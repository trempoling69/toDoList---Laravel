    ...
    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
        ...
        <div class="w-full">
            ...
            <div class="relative max-w-sm">
                ...
                <input datepicker type="text" name="end_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Selectionner la date" value="{{old('end_date', $task->end_date)}}">
            </div>
            @error('end_date')
            <div class="text-red-500">{{ $message }}</div>
            @enderror
